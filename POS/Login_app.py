...
class AdminPage:
    def __init__(self, window_init):
        ...
        admin_header.configure(text="PASODA GAS ADMIN", font=(font, 25, "bold"))
...
class CashierPage:
    def __init__(self, cashier_init):
        ...
        self.banner_frame_text.configure(text="PASODA GAS POS TERMINAL", font=(font, font_adjust(18), 'bold'),
                                         fg='white')
    ...
    def create_report(self):
        ...
        def report_generator(sales, mpesa_am, cash, discount, debts, expenses, floats, account_recv):
            ...
            pdf_creator.cell(w=0, h=8, txt="PASODA GAS", ln=1)
            ...
            pdf_creator.set_font("Arial", "", 11)
            pdf_creator.cell(w=0, h=7, txt="pasoda@gmail.com", ln=1)
